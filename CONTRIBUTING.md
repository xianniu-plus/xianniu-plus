...
- Issues should be opened via [Issue Template](https://issue.xianniu-plus.org/), fill in the form to provide
...
- Issues that with feature request should to go to [RFCs](https://github.com/xianniu-plus/rfcs/issues). This helps us managing the project.

Next section is for those who wants to help develop Xianniu Plus.
...
```shell
# If you would like to modify the website source code of https://xianniu-plus.org
...
You can follow the [LOCAL DEVELOPMENT GUIDE](https://xianniu-plus.org/en-US/guide/dev-guide.html) to do development more quickly.
...
We have a [commit template](https://xianniu-plus.org/en-US/guide/commit-examples.html)
