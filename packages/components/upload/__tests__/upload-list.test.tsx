...
describe('<upload-list />', () => {
  ...
  describe('functionalities', () => {
    test('handle preview works', async () => {
      ...
      await wrapper.find('.xn-upload-list__item-name').trigger('click')
      ...
      await wrapper.find('.xn-upload-list__item-preview').trigger('click')
    ...
    test('handle delete works', async () => {
      ...
      await wrapper.find('.xn-icon--close').trigger('click')
      expect(remove).toHaveBeenCalled()

      await wrapper.find('.xn-upload-list__item').trigger('keydown', {
      ...
      await wrapper.find('.xn-upload-list__item-delete').trigger('click')
