...
describe('Loading', () => {
  ...
  test('create directive', async () => {
    ...
    const maskWrapper = wrapper.find('.xn-loading-mask')
    ...
    vi.useRealTimers()
    await nextTick()
    expect(wrapper.find('.xn-loading-mask').exists()).toBeFalsy()
  })
  ...
  test('unmounted directive', async () => {
    ...
    await nextTick()
    expect(document.querySelector('.xn-loading-mask')).toBeFalsy()
  })
  ...
  test('body directive', async () => {
    ...
    await nextTick()
    const mask = document.querySelector('.xn-loading-mask')!
  ...
  test('lock directive', async () => {
    ...
    loading.value = false
    document.body.removeChild(document.querySelector('.xn-loading-mask')!)
  })
  ...
  test('text directive', async () => {
    ...
    await nextTick()
    expect(wrapper.find('.xn-loading-text').text()).toEqual('loading...')
  })
  ...
  test('create service', async () => {
    ...
    expect(document.querySelector('.xn-loading-mask')).toBeTruthy()
  })
  ...
  test('target service', async () => {
    ...
    const mask = container.querySelector('.xn-loading-mask')!
  ...
  test('fullscreen singleton service', async () => {
    ...
    let masks = document.querySelectorAll('.xn-loading-mask')
    ...
    masks = document.querySelectorAll('.xn-loading-mask')
  ...
  test('text service', async () => {
    ...
    const text = document.querySelector('.xn-loading-text')!
  ...
  test('customClass service', async () => {
    ...
    const customClass = document.querySelector('.xn-loading-custom-class')
  ...
  test("parent's display is not block", async () => {
    ...
    const maskDisplay = getComputedStyle(
      wrapper.find('.xn-loading-mask').element
    ).display
