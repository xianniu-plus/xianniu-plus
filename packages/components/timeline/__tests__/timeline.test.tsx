...
describe('TimeLine.vue', () => {
  test('create', () => {
    ...
    const contentWrappers = wrapper.findAll('.xn-timeline-item__content')
  ...
  test('placement', () => {
    ...
    const timestampWrapper = wrapper.findAll('.xn-timeline-item__timestamp')[0]
  ...
  test('hide-timestamp', () => {
    ...
    const timestampWrappers = wrapper.findAll('.xn-timeline-item__timestamp')
  ...
  test('color', () => {
    ...
    const vm = wrapper.vm
    const nodeElm = vm.$el.querySelector('.xn-timeline-item__node')
  ...
  test('type', () => {
    ...
    const nodeWrapper = wrapper.find('.xn-timeline-item__node')
  ...
  test('icon', () => {
    ...
    expect(wrapper.find('.xn-timeline-item__icon').exists()).toBe(true)
  ...
  test('dot', () => {
    ...
    const dotWrapper = wrapper.find('.xn-timeline-item__dot')

    expect(dotWrapper.text()).toEqual('dot')
    expect(wrapper.find('.xn-timeline-item__node').exists()).toBe(false)
  })
  ...
  test('center', () => {
    ...
    const timestampWrappers = wrapper.findAll('.xn-timeline-item')
