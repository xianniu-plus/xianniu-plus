...
describe('Calendar.vue', () => {
  it('create', async () => {
    ...
    const titleEl = wrapper.find('.xn-calendar__title')
    ...
    const rows = wrapper.element.querySelectorAll('.xn-calendar-table__row')
  ...
  it('range', () => {
    ...
    expect(
      wrapper.element.querySelector('.xn-calendar__button-group')
    ).toBeNull()
  })
  ...
  it('firstDayOfWeek', async () => {
    ...
    const head = wrapper.element.querySelector('.xn-calendar-table thead tr')
    expect(head?.firstElementChild?.innerHTML).toBe('Sun')
    expect(head?.lastElementChild?.innerHTML).toBe('Sat')
    const firstRow = wrapper.element.querySelector('.xn-calendar-table__row')
  ...
  it('click previous month or next month', async () => {
    ...
    await nextTick()
    const btns = wrapper.findAll('.xn-button')
  ...
  it('slots', async () => {
    ...
    expect(wrapper.find('.xn-calendar__header').text()).toEqual(AXIOM)
