import { buildProps, isBoolean } from '@xianniu-plus/utils'
import {
  useTooltipContentProps,
  useTooltipTriggerProps,
} from '@xianniu-plus/components/tooltip'
import { dropdownProps } from '@xianniu-plus/components/dropdown'
...
export const popoverProps = buildProps({
  ...
  /**
   * @description whether a tooltip arrow is displayed or not. For more info, please refer to [ElPopper](https://github.com/xianniu-plus/xianniu-plus/tree/dev/packages/components/popper)
   */
  showArrow: {
    type: Boolean,
    default: true,
