...
describe('Progress.vue', () => {
  test('percent', () => {
    ...
    expect(wrapper.find('.xn-progress__text').text()).toBe('66%')
    expect(wrapper.find('.xn-progress-bar__inner').attributes('style')).toBe(
  ...
  test('stroke width', () => {
    ...
    expect(wrapper.find('.xn-progress-bar__outer').attributes('style')).toBe(
      'height: 7px;'
    )
  })
  ...
  test('show text', () => {
    ...
    expect(wrapper.find('.xn-progress__text').exists()).toBe(false)
  })
  ...
  test('width', () => {
    ...
    expect(wrapper.find('.xn-progress-circle').attributes('style')).toBe(
  ...
  test('color', () => {
    ...
    expect(
      wrapper.find('.xn-progress-bar__inner').attributes('style')
  ...
  test('striped', () => {
    ...
    expect(wrapper.find('.xn-progress-bar__inner--striped').exists()).toBe(true)
  })
  ...
  test('striped flow', () => {
    ...
    expect(wrapper.find('.xn-progress-bar__inner--striped').exists()).toBe(true)
    expect(wrapper.find('.xn-progress-bar__inner--striped-flow').exists()).toBe(
      true
    )
  })
  ...
  test('format', () => {
    ...
    expect(wrapper.find('.xn-progress__text').text()).toBe('占比100%')
  })
  ...
  test('slot', () => {
    ...
    expect(wrapper.find('.xn-progress__text').text()).toBe('自定义内容')
  })
})
