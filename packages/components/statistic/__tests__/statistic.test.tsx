...
const TITLE_CLASS = '.xn-statistic__head'
const CONTENT_CLASS = '.xn-statistic__content'
const PERFIX_CLASS = '.xn-statistic__prefix'
const SUFFIX_CLASS = '.xn-statistic__suffix'
