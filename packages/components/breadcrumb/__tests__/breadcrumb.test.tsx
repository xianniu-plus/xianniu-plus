...
import { Check } from '@xianniu-plus/icons-vue'
...
describe('Breadcrumb.vue', () => {
  it('separator', () => {
    ...
    expect(wrapper.find('.xn-breadcrumb__separator').text()).toBe('?')
  })
  ...
  it('to', () => {
    ...
    expect(wrapper.find('.xn-breadcrumb__inner').classes()).toContain('is-link')
  })

  it('single', () => {
    const wrapper = _mount(() => <BreadcrumbItem>A</BreadcrumbItem>)
    expect(wrapper.find('.xn-breadcrumb__inner').text()).toBe('A')
    expect(wrapper.find('.xn-breadcrumb__separator').text()).toBe('')
  })
  ...
  describe('BreadcrumbItem', () => {
    ...
    it('click event', async () => {
      ...
      await wrapper.find('.xn-breadcrumb__inner').trigger('click')
