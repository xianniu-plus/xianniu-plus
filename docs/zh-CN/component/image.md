...
:::demo 自定义工具栏的内容可以通过使用 `slot = toolbar` 实现。从版本 ^(2.9.7) 开始，该 slot 新增了一个 `setActiveItem` 方法，可以根据索引进行切换。
...
| error             | 自定义图像加载失败的内容       | -                                                                                                                                                                                                                                |
| viewer            | 当图像预览时自定义内容        | -                                                                                                                                                                                                                                |
| progress ^(2.9.4) | 图片预览时自定义进度条内容      | ^[object]`{ activeIndex: number, total: number }`                                                                                                                                                                                |
