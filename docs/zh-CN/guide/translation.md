...
在本章中，我们将讨论如何帮助翻译 Xianniu Plus 开发文档。
...
2. 进入 [Xianniu Plus](https://crowdin.com/project/xianniu-plus) 项目。
3. 选择你想要贡献翻译的语言。
4. 选择你想要贡献翻译的具体文件。
5. 开始翻译。
...
你可以通过在 Crowdin [发起 issue](https://crowdin.com/project/xianniu-plus/discussions) 的方式通知我们，issue 内请告知你希望成为哪个语言的校对官。
