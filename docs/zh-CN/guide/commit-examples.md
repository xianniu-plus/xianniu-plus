...
关于**type** 和 **scope**属性允许的值可以在 [commitlint.config.js](https://github.com/xianniu-plus/xianniu-plus/blob/c2ee36a7fc72b17742d43ecdff4e2912c416141d/commitlint.config.js#L57) 文件内查看
