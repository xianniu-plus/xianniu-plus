...
Xianniu Plus components are using English **by default**, if you wish you use other
languages, you can get you answer by keep reading.

## Global configuration

Xianniu Plus provides global configurations

```ts [main.ts]
import XianniuPlus from 'xianniu-plus'
import zhCn from 'xianniu-plus/es/locale/lang/zh-cn'
...
Xianniu Plus also provides a Vue component [ConfigProvider](/en-US/component/config-provider)
...
If you are using Xianniu Plus via CDN, then you need to do this, let's again take
unpkg as an example

```html
<script src="//unpkg.com/xianniu-plus/dist/locale/zh-cn"></script>
<script>
  app.use(XianniuPlus, {
    locale: XianniuPlusLocaleZhCn,
  })
</script>
```
...
[Supported Language List](https://github.com/xianniu-plus/xianniu-plus/tree/dev/packages/locale/lang)
...
If you need any other languages, [PR](https://github.com/xianniu-plus/xianniu-plus/pulls)
is always welcomed, you only need to add a language file at
[here](https://github.com/xianniu-plus/xianniu-plus/tree/dev/packages/locale/lang).
