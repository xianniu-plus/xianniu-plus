...
| http-request                  | override default xhr behavior, allowing you to implement your own upload-file's request.                                                                                              | ^[Function]`(options: UploadRequestOptions) => XMLHttpRequest \| Promise<unknown>`                                                         | ajaxUpload [see](https://github.com/xianniu-plus/xianniu-plus/blob/dev/packages/components/upload/src/ajax.ts#L55) |
